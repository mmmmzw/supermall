    ...
    <div class="link_BG">
      <a href="转到个人用户界面">
        <div class="avatar">
          ...
          <img src="~assets/images/profile/vipnum_72x72.png" class="vip_sign" />
        </div>
      </a>
  ...
  computed: {
    uImg() {
      if (this.uBaseInfo.uavatar != "") {
        console.log(this.uBaseInfo.uavatar); //"assets/images/profile/avatar.svg"
...
#user_bar {
  height: 8rem;
  background: url("~assets/images/profile/userBG_750x229.png") 0 0 no-repeat;
...
.vip_link {
  background: url("~assets/images/profile/vip_1404x216.png") 0 0 no-repeat;
  width: 100%;
  height: 2.5rem;
